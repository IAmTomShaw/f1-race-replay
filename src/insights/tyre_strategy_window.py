...
# --- Maintainer's Visual Stint Tracker (Stint-based view) ---
...
class TyreStrategyWindow(PitWallWindow):
    """Visual stint history window (Maintainer's version)."""
...
# --- Your Live Tyre Info Window (Table-based view) ---

class TyreLiveInfoWindow(PitWallWindow):
    """Display current tyre compound/life and stint status by track position."""

    def setup_ui(self):
        self.setWindowTitle("Live Tyre Info")
        self.setGeometry(140, 140, 800, 520)
...
if __name__ == "__main__":
    ...
    # You can switch between windows here for testing
