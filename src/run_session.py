...
def run_arcade_replay(frames, track_statuses, example_lap, drivers, title,
                      ...
                      left_ui_margin=340, right_ui_margin=260, top_ui_margin=70, bottom_ui_margin=150,
                      total_laps=None, visible_hud=True, ready_file=None, session_info=None, session=None, enable_telemetry=True):
    window = F1RaceReplayWindow(
        ...
        left_ui_margin=left_ui_margin,
        right_ui_margin=right_ui_margin,
